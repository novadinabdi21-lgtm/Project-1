"""
Program Name: Soccer Quiz Game
Author: Novadin Abdi
Purpose: This program is a multiple choice soccer quiz that asks the user
10 questions about soccer. The program checks each answer, tracks
the user's score, displays the correct answers and the user's guesses, and
